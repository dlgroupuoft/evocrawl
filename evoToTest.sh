...
if [ -z "$APPNAME" ]
    then
        ...
        DEBUG_PRINT=1 BLIND=2 APPNAME=$APPNAME USER_MODE='a' ENABLE_KAFKA=0 REPLAY=0 MODE=0 node node_modules/testcafe/bin/testcafe.js 'chrome' crawl/evolutionarycrawler.js \
