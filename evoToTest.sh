...
if [ -z "$APPNAME" ]
    then
        ...
        INSERT_FOLDER=$INSERT_FOLDER DEBUG_PRINT=1 BLIND=2 APPNAME=$APPNAME USER_MODE='a' ENABLE_KAFKA=0 REPLAY=0 MODE=0 INPUTS_DETECTION=1 node node_modules/testcafe/bin/testcafe.js 'chrome' crawl/evolutionarycrawler.js \
