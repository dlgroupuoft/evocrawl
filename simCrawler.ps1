...
mkdir data/$Env:APPNAME/sim_log
mkdir data/$Env:APPNAME/sim_set
mkdir data/$Env:APPNAME/sim_responses
node .\node_modules\testcafe\bin\testcafe.js "chrome" .\crawl\simplecrawler.js `
